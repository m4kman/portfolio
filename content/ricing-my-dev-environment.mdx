...
For the last couple of months, I've made the switch to **_Neovim_** - something that always excited me. Starting off with a VIM-based editor can be difficult, and it certainly does not attract everyone. It's a niche area.
...
To get a UNIXX-like experience on Windows (I've used Arch and other distros in the past), I had to replace Powershell with something else. Luckily, Git comes with the **bash shell** binary for Windows, and my problem was solved.

With the shell sorted, I had to find the right terminal. The native Windows Terminal didn't cut it, it felt off and slow, even though I tried to make it work. **Hyper** felt good, and I actually liked it, but I didn't actually stop there.

Lo and behold, I eventually stumbled upon on Wezterm and while it didn't click right off the bat, it certainly has become my go-to choice.

With a few minor customizations, I had filled the Terminal whole.
