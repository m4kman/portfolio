...
<p className="line-through">To get a UNIXX-like experience on Windows (I've used Arch and other distros in the past), I had to replace Powershell with something else. Luckily, Git comes with the **bash shell** binary for Windows, and my problem was solved.</p> (I switched to Arch Linux)
