      ...
      {meteors.map((el, idx) => (
        <span
          ...
          className={cn(
            ...
            rounded-[9999px] bg-slate-500/75 shadow-[0_0_0_1px_#ffffff10]`,
            `before:absolute before:top-1/2 before:h-[1px] before:w-[50px]
            before:-translate-y-[50%] before:transform before:bg-gradient-to-r
            before:from-[#64748b]/75 before:to-transparent before:content-['']`,
            className,
          )}
          style={{
            top: 0,
            left: Math.floor(Math.random() * (750 - -750) + -750) + "px",
